...
$text .= "|#############################################################|\n";
$text .= "\033[1;91m[!] WARNING: \033[0mThe Author is not responsible for illegal users.\n";
$text .= "      __      __      ___             __  __              \n";
$text .= "     /  \    /  \ ____\_ |__    _____|__|/  |_  ____      \n";
$text .= "     \   \/\/   // __ \| __ \  /  ___/  \   __\/ __ \     \n";
$text .= "      \        /\  ___/| \_\ \ \___ \|  ||  | \  ___/     \n";
$text .= "       \__/\  /  \___  >___  / /___  >__||__|  \___  >    \n";
$text .= "            \/       \/    \/      \/              \/     \n";
$text .= "    _________                                            \n";
$text .= "   /   _____/ ____  _____    ____   ____   ___________    \n";
$text .= "   \_____  \_/ ___\ \__  \  /    \ /    \_/ __ \_  __ \   \n";
$text .= "   /        \  \___  / __ \|   |  \   |  \  ___/|  | \/   \n";
$text .= "  /_______  /\___  >/____  /___|  /___|  /\___  >__|      \n";
$text .= "          \/     \/      \/     \/     \/     \/          \n";
$text .= "\n";
$text .= "  Website vulnerable scanner Tools by CyberCommands\n";
$text .= "|#############################################################|\n";
$text .= "\n";
print $text;
}
...
function Tips() {
    print "\033[92m[Tips] \033[0mFor help, type 'help' and to quit please type 'quit'\n";
}
...
'/mysql-admin/',
        ...
        print "\n[!] pmaPWN! - phpMyAdmin Code Injection Exploit(PHP) by CyberCommands\n\n";
        print "[*] Site : ".$site."\n";
...
function con_host($host) {
    ...
    curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.3 Safari/605.1.15');
    $pg = curl_exec($ch);
    if($pg){
        return $pg;
    } else {
